...
export const getStatusUser = (userId: number) => {
    return async (dispatch: any) => {
        const response = await profileAPI.getStatus(userId);
        dispatch(setUserStatus(response.data));
    };
};
export const updateStatusUser = (status: string) => {
    return async (dispatch: any) => {
...
export const saveProfile = (userProfile: UserProfileType) => async (dispatch: any, getState: any) => {
